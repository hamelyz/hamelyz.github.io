...
function lb(a){var b={};b=G(b,"http_origin",document.URL);b=G(b,"user_agent",navigator.userAgent);b=G(b,"language",$a());b=G(b,"screen_width",screen.width||0);b=G(b,"screen_height",screen.height||0);b=G(b,"http_referrer",document.referrer);b=G(b,"browser_fingerprint_id",a.L);b=G(b,"developer_identity",a.m);b=G(b,"identity",a.m);b=G(b,"sdk","web");b=G(b,"sdk_version","2.85.4");b=mb(b,"model",y?y.model:"");return b=mb(b,"os_version",y?y.platformVersion:"")}
...
d.D)),null);if(0===d.A||!d.A)return g(Error(A("Branch SDK not initialized")),null)}m.unshift(g);b.apply(d,m)})}}function Z(){if(!(this instanceof Z))return kd||(kd=new Z),kd;this.ia=ec();this.g=new Fb;this.$=new Lb;this.u=[];this.ca="web2.85.4";this.l={};this.B=this.A=0;this.D=null}
